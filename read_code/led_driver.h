...
#define LED_PIN 13 //Input pin for the shift registers
#define SRCLK 15 //Shift register clock, used when shifting bits in 
#define RCLK 14 //Clock, used when using parallel output of registers
